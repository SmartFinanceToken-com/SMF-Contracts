...
// Dependency file: contracts/baby/SMARTFINANCEDividendTracker.sol
...
contract SMARTFINANCEDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    uint256 public  totalWalletsExcludedFromDividends;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SMARTFINANCE contract."
        );
    }

    function excludeFromDividends(address account) external onlyOwner {
        require(!excludedFromDividends[account]);
        require(totalWalletsExcludedFromDividends < 10,"Cannot exclude");
       ...
       totalWalletsExcludedFromDividends+=1;
...
// Root file: contracts/baby/SMARTFINANCE.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/SMARTFINANCEDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract SmartFinance is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    SMARTFINANCEDividendTracker public dividendTracker;
    ...
    uint256 public totalWalletsExcludedFromFees;
    ...
    constructor(
        ...
        require(totalFees <= 14, "Total fee is over 14%");
        swapTokensAtAmount = totalSupply_.mul(2).div(10**6); // 0.002%

        // use by default 300,000 gas to process auto-claiming dividends
        gasForProcessing = 300000;

        dividendTracker = SMARTFINANCEDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "SMARTFINANCE: The dividend tracker already has that address"
        );

        SMARTFINANCEDividendTracker newDividendTracker = SMARTFINANCEDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "SMARTFINANCE: The new dividend tracker must be owned by the SMARTFINANCE token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "SMARTFINANCE: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "SMARTFINANCE: Account is already the value of 'excluded'"
        );
        require(totalWalletsExcludedFromFees <10, "Cannot exclude");

        _isExcludedFromFees[account] = excluded;
        totalWalletsExcludedFromFees+=1;
    ...
    function setTokenRewardsFee(uint256 value) external onlyOwner {
        ...
        totalFees = tokenRewardsFee.add(liquidityFee).add(marketingFee);
        require(totalFees <= 25, "Total fee is over 14%");
    }
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "SMARTFINANCE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "SMARTFINANCE: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "SMARTFINANCE: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "SMARTFINANCE: Cannot update gasForProcessing to same value"
        );
